...
//    console.log('kf',myboxMotion.currTime,'=',myboxMotion.getAvars());    // interpolate for t=2.9
    ...
    luxoMotion.addKeyFrame(new Keyframe('straight',         0.0, [-7, 0,   0, -25, 25, 0]));
    luxoMotion.addKeyFrame(new Keyframe('straight',         2.0, [-7, 0,   0, -25, 100, 0]));
    luxoMotion.addKeyFrame(new Keyframe('straight',         2.0, [-7, 0,   0, -70, 180, 0]));
    luxoMotion.addKeyFrame(new Keyframe('straight',         2.0, [-7, 0,   0, -100, 180, 0]));
    luxoMotion.addKeyFrame(new Keyframe('straight',         2.0, [-7, 0,   0, -100, 130, 0]));  // touches teapot

    luxoMotion.addKeyFrame(new Keyframe('straight',         2.0, [-7, 0,   0, -100, 180, 0]));
    luxoMotion.addKeyFrame(new Keyframe('straight',         3.0, [-7, 0,   0, -100, 180, 0])); // stays
    
    luxoMotion.addKeyFrame(new Keyframe('straight',         1.0, [-7, 0,   0, -25, 25, 0]));  // jump
    luxoMotion.addKeyFrame(new Keyframe('straight',         0.3, [-7, 0,   0, -70, 150, 0]));  // jump
    luxoMotion.addKeyFrame(new Keyframe('straight',         0.3, [-7, 3,   0, -50, 130, 0]));
    luxoMotion.addKeyFrame(new Keyframe('straight',         0.3, [-7, 3,   0, -50, 100, 0]));
    luxoMotion.addKeyFrame(new Keyframe('straight',         0.3, [-7, 3,   0, -110, 60, 180]));  // touches teapot

    luxoMotion.addKeyFrame(new Keyframe('straight',         1.0, [-7, 0.5, 0, -30, 100, 0]));
    luxoMotion.addKeyFrame(new Keyframe('straight',         3.0, [-7, 0,   0, -25, 25, 0]));
...
function updateLuxo(avars) {
    ...
    luxo1.matrix.multiply(new THREE.Matrix4().makeTranslation(xPosition,yPosition,4));   
